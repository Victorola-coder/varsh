...
export default function Hero() {
  return (
    <motion.div
      ...
      animate="animate"
      exit="exit"
      className="bg-[url('/images/hero.png')] bg-no-repeat text-white w-screen min-h-screen bg-body flex flex-col items-center justify-center relative bg-cover bg-center"
    >
